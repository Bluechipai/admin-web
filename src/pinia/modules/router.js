...
const KeepAliveFilter = (routes) => {
  routes && routes.forEach(item => {
    //  zi cài dān zhōng yǒu keep-alive  de， fù cài dān yě bì xū keep-alive， fǒu zé wú xiào。 zhè lǐ jiāng zi cài dān zhōng yǒu keep-alive  de fù cài dān yě jiā rù。
...
export const useRouterStore = defineStore('router', () => {
  ...
  const routeMap = ({})
  //  cóng hòu tái huò qǔ dòng tài lù yóu
