      ...
      <el-main class="main-cont main-right">
        <transition :duration="{ enter: 800, leave: 100 }" mode="out-in" name="el-fade-in-linear">
          ...
          >
                ...
                <el-header class="header-cont">
                  <el-row class="pd-0">
                    ...
                    <el-col :xs="10" :lg="14" :md="14" :sm="9" :xl="14" :pull="1">
                      <!--  xiū gǎi wèi shǒu jī duān bù xiǎn shì dǐng bù biāo qiān -->
                            ...
                            <el-dropdown-menu class="dropdown-group">
                              <el-dropdown-item>
                                <span style="font-weight: 600;">
                                   dāng qián jiǎo sè：{{ userStore.userInfo.authority.authorityName }}
                                </span>
                              </el-dropdown-item>
                              ...
                              <el-dropdown-item icon="avatar" @click="toPerson"> gè rén xìn xī</el-dropdown-item>
                              <el-dropdown-item icon="reading-lamp" @click="userStore.LoginOut"> dēng  chū</el-dropdown-item>
                            </el-dropdown-menu>
                          </template>
                        </el-dropdown>
                      </div>
            ...
            <!--  dāng qián miàn bāo xiè yòng lù yóu zì dòng shēng chéng kě gēn jù xū qiú xiū gǎi -->
            <!--
            :to="{ path: item.path }"  zàn shí zhù shì bù yòng-->
        ...
        <router-view
          ...
          element-loading-text=" zhèng zài jiā zài zhōng"
          class="admin-box"
        >
          <div>
...
const initPage = () => {
  //  pàn duàn dāng qián yòng hù de cāo zuò xì tǒng
  if(window.localStorage.getItem('osType') === 'WIN') {
    first.value = 'Ctrl'
  } else {
    first.value = '⌘'
  }
  //  dāng yòng hù tóng shí àn xiàctrl hék jiàn de shí hòu
  const handleKeyDown = (e) => {
    if (e.ctrlKey && e.key === 'k') {
      //  zǔ zhǐ liú lǎn qì mò rèn shì jiàn
      e.preventDefault();
      handleCommand()
    }
  }
...
onMounted(() => {
  //  guà zài yī xiē tōng yòng de shì jiàn
