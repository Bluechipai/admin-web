<template>
  <div class="router-history">
    ...
    <!-- zì dìng yì yòu jiàn cài dānhtml dài mǎ-->
    <ul
      v-show="contextMenuVisible"
      :style="{ left: left + 'px', top: top + 'px' }"
      class="contextmenu"
    >
      <li @click="closeAll"> guān bì suǒ yǒu</li>
      <li @click="closeLeft"> guān bì zuǒ cè</li>
      <li @click="closeRight"> guān bì yòu cè</li>
      <li @click="closeOther"> guān bì qí tā</li>
    </ul>
  </div>
</template>
...
const initPage = () => {
  //  quán jú jiān tīng  guān bì dāng qián yè miàn hán shù
  emitter.on('closeThisPage', () => {
    removeTab(name(route))
  })
  //  quán jú jiān tīng  guān bì suǒ yǒu yè miàn hán shù
