<template>
  ...
  >
    <template #header>
      <input v-model="searchInput" class="quick-input" placeholder=" qǐng shū rù nǐ xū yào kuài jié dào dá de gōng néng">
    </template>
    ...
    <template #footer>
      <span class="dialog-footer">
        <el-button @click="close"> guān bì</el-button>
      </span>
    </template>
  </el-dialog>
</template>
...
const addQuickOption = () => {
  ...
  const quickArr = [
    {
      label: ' liàng sè zhǔ tí',
      func: () => changeMode('light')
    }, {
      label: ' àn sè zhǔ tí',
      func: () => changeMode('dark')
    }, {
      label: ' tuì chū dēng lù',
